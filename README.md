...
# Credits
credits to heytulsiprasad (on github) for the [removing edge script](https://gist.github.com/heytulsiprasad/670b7451a1931cfd354c4813c74ac181) and ChrisTitus for some of his code from his tweaks from his util since thats what inspired me to make my own to have only the tweaks that i want. also WinAero Tweaker, there are some tweaks from them too
